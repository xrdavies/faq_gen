...
- _1004._ **People are always worried about the transaction speed because they worry about their transaction going to fail. How fast and secure is “Gear Technologies” platform? If the number of users spikes, will transactions on “Gear Technologies” get congested?**
...
- _1005._ **Security is always a concern as well as determining the success of each project! With #GearTech, what partners do you have to improve security for investors? Are there any compensation policies if they are unfortunately misappropriated?**

  Currently, we’re making our protocol feature-complete. After that we will undergoing a security and economical audit. As long as Gear is a proposed Kusama/ Polkadot parachain -- we also guarantee the resistance of attacks with pooled security of Polkadot/Kusama. Bug-bounty program is also one of our priorities -- it will be permanent.

- _1006._ **Many new projects develop well at first, but then fail to achieve good results. How will you manage and develop your project to gain a position in the market and become a good project in the blockchain industry?**
...
- _1007._ **Crypto people say that the next boom will on NFT after the Defi, Do you agree with this? And what are the plans of "Gear Technologies" to build on NFT concept/Technology? Any future idea about NFT?**
...
- _1008._ **Could you explain to us in simple terms what is the purpose of "Gear Technologies"? What is the strongest advantage that you think will make this team lead the market? How will you attract investors and build the trust and win the hearts of millions of people in your project?**
...
- _1009._ **Please explain what is the advantage of #GearTech over similar projects? How can you capture the most value from this nascent market for data governance, among others? **
...
- _1010._ **As I know, strong backing and partnerships in the crypto market might bring huge benefits to new projects. During this point, can you tell us about the investors and partners of your project ? What benefits to the "GearTech" ecosystem do you expect from them?**
...
- _1011._ **Building and giving trust to the community is one of the toughest challenges because of the many frauds and crimes happening in crypto today, how can you solve this problem and convince investors to invest?**
...
- _1012._ **Could you give an overview of $GRB Token tokenomics? Will the design of the token rise and fall with the success of the platform, does it include any scarce paths, such as equity, storage or burning?**
...
- _1013._ **How is #GearTech planning to attract users and show that #GearTech is a tool with better underlying technology and easier, more intuitive development experience? What are the challenges you are trying to solve in the next 6-12 months?**
...
- _1014._ **When did Gear decide to roll out Gear Token Public Sale? Can you tell me how to participate in Gear public sale?**

  We are not planning to organize a public token sale, but you can earn our bonus token as a reward for taking part in our workshops, hackathons etc. All bonus tokens can be changed for native Gear tokens. If you want to stay up to date and always be the first to know about our upcoming events,  we will be glad if you will join our community on Twitter and Discord. https://discord.com/invite/7BQznC9uD9

- _1015._ **I’m a developer, and I’m interested in contributing to your project alongsides earning, Do you have any Bug Bounty to check for vulnerabilities ? How can i become a part of "Gear Technologies" ?**

  Please feel free to talk about it to our crew in our Discord https://discord.com/invite/7BQznC9uD9

- _1016._ **In the world crypto competition, features are of primary importance to attracting investors and the community! Can "Gear Technologies" provide a list of killer features that scare competitors into your project?**
...
- _1017._ **What do you think about the Asian market in crypto? Does your project have any plans in the future to go to ASEAN which is a potential market in crypto?**
...
- _1018._ **Gear Technologies currently resides in the Polkadot network. But, do you have plans to expand to other networks like Solana, BSC, ETH, etc?**
...
- _1019._ **If we want to stake and farm "Gear Technologies", how will the profit be calculated? and will "Gear Technologies" cooperate with DEX AMMs from other projects such as Pancakeswap?**
...
- _1020._ **Could you tell us about the background and experience of Gear Technologies's development team? How will they carry out your project during this current pandemic?**
...
- _1021._ **The N-Covid epidemic is affecting the entire world economy and "Gear Technologies" is no exception. So, how does the disease affect "Gear Technologies"? Do you have a plan to reduce the damage caused by Covid?**
...
- _1022._ **Please introduce Gear in the most concise way.**
...
- _1023._ **Can you talk about your experience in Parity? What experience did you learn from and can be used on Gear?**
...
- _1024._ **Polkadot already has several chains that support smart contracts, such as Acala, Moonbeam and Astar. Why do we still need Gear?**
...
- _1025._ **Why did you choose Web Assembly contract. Will EVM compatibility be considered in the future?**
...
- _1026._ **What do you think is the key point for a smart contract platform to attract developers? What will you do accordingly to build your own developer ecosystem?**
...
- _1027._ **What is the current stage of Gear? When are going to bid for Polkadot and Kusama Parachain slot?**
...
- _1028._ **At this stage, how can developers and the community participate in Gear?**
...
- _3002._ **How can we participate in Gear's testnet now? Do you have any relevant documents?**

  You can review our Wiki and follow the insrtuctions. https://wiki.gear-tech.io/getting-started-in-5-minutes/ 

- _3003._ **Are Gear seed round and PE round are over?**

  Yes，Seed round is over.

- _3004._ **Technical paper in Chinese**

  https://github.com/GearFans/gear-technical/blob/cn/c

- _3005._ **Gear's technical paper**

  https://github.com/gear-tech/gear-technical/blob/master/TECHNICAL.pdf  
...
- _3007._ **Do you have token available on marketcap now? Any link i can learn about Gear please? Thanks!**
